...
import "../../theme/sass/components/team.scss";
  ...
  return (
    <div>
      <div className="tb">
        <h1>Core Team</h1>
        <p>
          Our Core Team embody who we are as an organization, and guide our
          thinking and activities as we strive to impact the communities we
          work.
        </p>
        <div className="team-row">
          <div className="profile-box">
            <h4>Dr Ayodotun Olutola</h4>
